...
XUI_GO_TEMPLATE_8_LINES = [
    ...
    "				baseURL := proto + \"://\" + ipPort",
    "				req.SetRequestURI(baseURL)",
    "				req.Header.Set(\"Referer\", baseURL+\"/\")",
    "				if client.DoTimeout(req, resp, {timeout}*time.Second) != nil { continue }",
...
ALIST_GO_TEMPLATE_LINES = [
    ...
    "		if client.DoTimeout(req, resp, {timeout}*time.Second) == nil && resp.StatusCode() == fasthttp.StatusOK {",
